                    ...
                    <div classname="col-md-8">
                        <div classname="entity_wrapper">
                            ...
                            <div classname="entity_thumb">
                                <img classname="img-responsive" src="assets/img/category_img_top.jpg" alt="feature-top" />
                            </div>
                            ...
                            <div classname="entity_social">
                                <span><i classname="fa fa-share-alt" />424 <a href="#">Shares</a> </span>
                                <span><i classname="fa fa-comments-o" />4 <a href="#">Comments</a> </span>
                            </div>
                        </div>
                        <div classname="row">
                            <div classname="col-md-6">
                                <div classname="category_article_body">
                                    <div classname="top_article_img">
                                        <img classname="img-fluid" src="assets/img/category_img1.jpg" alt="feature-top" />
                                    </div>
                                    ...
                                    <div classname="article_social">
                                        <span><a href="#"><i classname="fa fa-share-alt" />424 </a> Shares</span>
                                        <span><i classname="fa fa-comments-o" /><a href="#">4</a> Comments</span>
                                    </div>
                                </div>
                            </div>
                            <div classname="col-md-6">
                                <div classname="category_article_body">
                                    <div classname="top_article_img">
                                        <img classname="img-responsive" src="assets/img/category_img2.jpg" alt="feature-top" />
                                    </div>
                                    <div classname="category_article_title">
                                        <h5><a href="single.html" target="_blank">Airbnb launches photo-centric app for iPads and Android
                                            tablets. </a></h5>
                        ...
                        <div classname="widget_advertisement">
                            <img classname="img-responsive" src="assets/img/category_advertisement.jpg" alt="feature-top" />
                        </div>
                        <div classname="row">
                            <div classname="col-md-6">
                                <div classname="category_article_body">
                                    <div classname="top_article_img">
                                        <img classname="img-responsive" src="assets/img/category_img3.jpg" alt="feature-top" />
                                    </div>
                                    <div classname="category_article_title">
                                        <h5><a href="single.html" target="_blank">Airbnb launches photo-centric app for iPads and Android
                                            tablets. </a></h5>
                            ...
                            <div classname="col-md-6">
                                <div classname="category_article_body">
                                    <div classname="top_article_img">
                                        <img classname="img-responsive" src="assets/img/category_img4.jpg" alt="feature-top" />
                                    </div>
                                    <div classname="category_article_title">
                                        <h5><a href="single.html" target="_blank">Airbnb launches photo-centric app for iPads and Android
                                            tablets. </a></h5>
                        ...
                        <nav aria-label="Page navigation" classname="pagination_section">
                            <ul classname="pagination">
                                ...
                                <li><a href="#">5</a></li>
                                <li>
                                    <a href="#" aria-label="Next" classname="active"> <span aria-hidden="true">»</span> </a>
                                </li>
                            </ul>
                        </nav>
                    </div>
