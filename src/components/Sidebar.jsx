        ...
        <div>
            <div className="col-md-4">
                <div className="widget">
                    ...
                    <div className="media">
                        <div className="media-left">
                            <a href="#"><img className="media-object" src="assets/img/pop_right1.jpg" alt="Generic placeholder image" /></a>
                        </div>
                        <div className="media-body">
                            <h3 className="media-heading">
                                <a href="single.html" target="_self">Canon launches photo centric 00214 Model supper shutter camera</a>
                            </h3> <span className="media-date"><a href="#">10Aug- 2015</a>,  by: <a href="#">Eric joan</a></span>
                ...
                <div className="widget reviews m30">
                    ...
                    <div className="media">
                        <div className="media-left">
                            <a href="#"><img className="media-object" src="assets/img/pop_right2.jpg" alt="Generic placeholder image" /></a>
                        </div>
                        <div className="media-body"><h3 className="media-heading"><a href="single.html" target="_self">Samsung is the best
                            mobile in the android market.</a></h3> <span className="rating">
                                <i className="fa fa-star"></i>
                                <i className="fa fa-star"></i>
                                <i className="fa fa-star"></i>
                                <i className="fa fa-star"></i>
                    ...
                    <div className="media">
                        <div className="media-left">
                            <a href="#"><img className="media-object" src="assets/img/pop_right3.jpg" alt="Generic placeholder image" /></a>
                        </div>
                        <div className="media-body">
                            <h3 className="media-heading">
                    ...
                    <div className="media">
                        <div className="media-left">
                            <a href="#"><img className="media-object" src="assets/img/pop_right4.jpg" alt="Generic placeholder image" /></a>
                        </div>
                        <div className="media-body">
                            <h3 className="media-heading">
                ...
                <div className="widget m30">
                    ...
                    <div className="widget_body"><img className="img-responsive left" src="assets/img/editor.jpg"
