...
export default function Footer() {
    return (
        <div>
            ...
            {/* <a href="#" className="crunchify-top"><i className="fa fa-angle-up" aria-hidden="true"></i></a>
            <div className="uc-mobile-menu uc-mobile-menu-effect">
                <button type="button" className="close" aria-hidden="true" data-toggle="offcanvas"
                    id="uc-mobile-menu-close-btn">&times;</button>
                <div>
                    <div>
                        <ul id="menu">
                            <li className="active"><a href="blog.html">News</a></li>
